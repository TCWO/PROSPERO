...
df_data_training <- read.csv2(file.path('..', 'Data', 'CellLines', 'Clustering', 'df_data_consensus_batches2and3.csv'), stringsAsFactors = FALSE)
...
saveRDS(tmp_svm, file.path('..', 'Data', 'CellLines', 'svm_models', 'svm_model_tumor_subtypes_batches2and3.RDS'))
...
write.csv2(df_data_all, file.path('..', 'Data', 'CellLines', 'Clustering', 'data_annotated_tumor_subtypes_batches2and3.csv'), row.names = FALSE)
