...
df_dictionary <- read.csv2(file.path('..', 'Data', 'CellLines', 'Clustering', 'Clusters_annotated', 'flowsom_clusters_sorted_batches2and3_annotated.csv'), stringsAsFactors = FALSE) %>% 
  bind_rows(read.csv2(file.path('..', 'Data', 'CellLines', 'Clustering', 'Clusters_annotated', 'kmeans_clusters_sorted_batches2and3_annotated.csv'), stringsAsFactors = FALSE)) %>% 
  bind_rows(read.csv2(file.path('..', 'Data', 'CellLines', 'Clustering', 'Clusters_annotated', 'phenograph_clusters_sorted_batches2and3_annotated.csv'), stringsAsFactors = FALSE)) %>% 
  bind_rows(read.csv2(file.path('..', 'Data', 'CellLines', 'Clustering', 'Clusters_annotated', 'clara_clusters_sorted_batches2and3_annotated.csv'), stringsAsFactors = FALSE)) %>% 
...
df_data <- read.csv2(file.path('..', 'Data', 'CellLines', 'Clustering', 'df_data_clusters_batches2and3.csv'), stringsAsFactors = FALSE) %>% 
...
write.csv2(df_data_r, file.path('..', 'Data', 'CellLines', 'Clustering', 'df_data_consensus_batches2and3.csv'), row.names = FALSE)
